            ...
            <Router>
                ...
                <div className="scrollOptimize">
                    <Routes>
                        ...
                        <Route exact path="/addquestion" element={ user === true ? <Addquestion /> : <SignIn toggleUser={toggleUser} /> } />
                        <Route exact path="/confirmquestion" element={user === true ? <Confirmquestion /> : <SignIn toggleUser={toggleUser} /> } />
